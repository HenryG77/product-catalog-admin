  ...
  const fetchData = async () => {
    try {
      ...
      const sampleCategories = [
        { _id: '1', name: 'Perfumes en Gral.', active: true },
        { _id: '2', name: 'Mochilas', active: true },
        { _id: '3', name: 'Carteras para Damas', active: true },
        { _id: '4', name: 'Bolsos Térmicos', active: true },
        { _id: '5', name: 'Lienzos', active: true },
        { _id: '6', name: 'Joyas Aceros Quirurgicos', active: true },
        { _id: '7', name: 'Cremas en Gral.', active: true },
        { _id: '8', name: 'Salud', active: true }
      ];
      ...
      setProducts(sampleProducts.filter((p: Product) => p.active));
      setCategories(sampleCategories.filter((c: Category) => c.active));
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              {store?.logo && (
                <img src={store.logo} alt={store.name} className="h-10 w-10 rounded-lg" />
              )}
              <div>
